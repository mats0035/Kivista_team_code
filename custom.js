...
$().ready(function() {
  ...
  */
  ...
  let parent = document.getElementById('competencies') // 'ol' elements
  parent.innerHTML = htmlArray.join('')
  // Default setting on the competency tree
  parent = document.getElementById('competency-tree') // 'ol' elements
  for (let i=0; i < 10;i++) {
   htmlArray.pop()
  }
  parent.innerHTML = htmlArray.join('')
  ...
  */
  ...
  const defaultGuid = []
  var tmp1 = document.getElementById('foundation-view')
  ...
  */
  ...
  $('.sort-option').click(function() {
    ...
    const currentOl = document.getElementById('competencies') // 'ol' elements
    const currentLis = currentOl.getElementsByClassName('list-item') // 'li' elements
    const sortTarget = currentOl.getElementsByClassName('itemTitle') // 'span' elements with 'itemTitle' class
    const sortCounter = currentOl.getElementsByClassName('counter')  // number of the EO in the tree
    ...
    for (let l = 0; l < sortedElement.length; l++) {
      currentOl.appendChild(currentOl.removeChild(sortedElement[l]))
    }
